 ...
 * @author jarteaga
 */
public class ReporteRelOtrosGas 

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(int consecutivo)
    {
        try
        {
       ...
       // JasperReport subreporte;
        ...
        URL  in = this.getClass().getResource("/sistemaviaticosutd/reportes/generales/relacion_otros_gastos.jasper");//Ruta del reporte maestro
...
//       
         ...
         parametros.put("consecutivo",consecutivo);//Nombre del parametro en el reporte y la variable q se le va asignar al parametro
       ...
       //  parametros.put("encabezado",this.getClass().getResourceAsStream(encabezado));//Carga la imagen encabezado en el reporte
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("Sistema Viaticos UTD - Relación Otros Gastos");
