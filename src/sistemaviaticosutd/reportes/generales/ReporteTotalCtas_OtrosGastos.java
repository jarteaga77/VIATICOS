 ...
 * @author jarteaga
 */
public class ReporteTotalCtas_OtrosGastos 

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(Date fecha_ini, Date fecha_fin)
    {
        ...
        URL  in = this.getClass().getResource("/sistemaviaticosutd/reportes/generales/reportectas_otros.jasper");//Ruta del reporte maestro
        ...
        URL  in1 = this.getClass().getResource("/sistemaviaticosutd/reportes/generales/detalle_otros_gastos.jasper");//Ruta del reporte maestro
       ...
       //  parametros.put("encabezado",this.getClass().getResourceAsStream(encabezado));//Carga la imagen encabezado en el reporte
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("Sistema Viaticos UTD - Reporte Ctas Otros Gastos");
