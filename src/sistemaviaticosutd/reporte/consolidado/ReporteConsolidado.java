...
package sistemaviaticosutd.reporte.consolidado;
...

{
  ...
  //private final String pie="/UTDVVCC/recursos/pie.png";
    ...
    public void ejecutarReporte(Date  desde, Date hasta)
    {
        try
        {
...
//        JasperReport total;
        ...
        URL  in = this.getClass().getResource("/sistemaviaticosutd/reporte/consolidado/consolidado_mes.jasper");//Ruta del reporte maestro
...
//        
         ...
         parametros.put("inicial",desde);//Nombre del parametro en el reporte y la variable q se le va asignar al parametro
         parametros.put("final",hasta);//Nombre del parametro en el reporte y la variable q se le va asignar al parametro
...
//         parametros.put("total", total);
       ...
       //  parametros.put("encabezado",this.getClass().getResourceAsStream(encabezado));//Carga la imagen encabezado en el reporte
        // parametros.put("pie",this.getClass().getResourceAsStream(pie));//Carga la imagen pie en el reporte
         ...
         jviewer.setTitle("Sistema Viaticos UTD - Reporte Consolidado Mes");
