 ...
 * @author jarteaga
 */
public class JIFAprobacionCtaOtros extends javax.swing.JInternalFrame {
   ...
   // private ReporteTecnicos_1 reporte;
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Aprobación Otros Gastos");
        setToolTipText("");
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
       boolean aprobado;
        ...
        {
            aprobado=true;
            conexion.executeUpdateQuery("UPDATE viaticos.cuenta_otros_cobros SET cta_aprobada='"+aprobado+"',persona_aprueba="+id_usuario+" WHERE id_cta_otros="+id_manejo+" AND id_otros_cobros="+idacta+" ");
    ...
    public void detalleTabla()
    {
         ...
         */
        ResultSet obj=conexion.executeQuery("SELECT cta.id_cta_otros AS cuenta, cta.id_otros_cobros AS consecutivo,cta.fecha_sistema AS fecha, "
                + "us.cedula_usuario AS cedula,(us.nombre_usuario ||' '|| us.apellido_usuario)AS nombre,"
                + "SUM(det.tarifa)AS total "
        ...
        try {
            ...
            Logger.getLogger(JIFAprobacionCtaOtros.class.getName()).log(Level.SEVERE, null, ex);
        }
