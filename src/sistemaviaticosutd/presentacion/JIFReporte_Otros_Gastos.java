...
import sistemaviaticosutd.reportes.generales.ReporteTotalCtas_OtrosGastos;

/**
 *
 * @author jarteaga
 */
public class JIFReporte_Otros_Gastos extends javax.swing.JInternalFrame {

   private ReporteTotalCtas_OtrosGastos reporte;
   //private ReporteTotalCtas1 reporte1;
    public JIFReporte_Otros_Gastos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Generación de Reporte Total Ctas Otros Gastos");
        setToolTipText("");
    ...
    private void btn_ejecutarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ejecutarActionPerformed
        reporte=new ReporteTotalCtas_OtrosGastos();
